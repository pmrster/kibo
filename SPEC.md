...
- **Mascot**: An original 8-bit ghost — the wrong layout haunting your sentence. It perches on the top edge of the input field with its tails tucked behind, blinks while it waits, and shuts its eyes contentedly after a copy. It appears in the converter, About, and Settings. Small vertical eyes and no mouth: at this size a mouth is either a slab or a nose, and two holes carry the whole expression.
