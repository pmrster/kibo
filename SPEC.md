...
- **Branding**: The app presents as “Who Forgot To Change Lang” in the converter, the About and Settings windows, and distribution metadata. The entire interface is English; Thai appears only in the text being converted. “ใครลืมเปลี่ยนภาษา” stays the project's Thai name in prose.
